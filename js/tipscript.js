$(document).ready(function(){
	...
	/*$('.main p').replaceWith('<div class="slideOutTip '+$(this).attr('class')+'" style="'+$(this).attr('style')+'"><div class="tipVisible"><div class="tipIcon"><div class="plusIcon"></div></div><p class="tipTitle">'+$(this).attr('title')+'</p></div><div class="slideOutContent"><p>'+$(this).html()+'</p></div></div>'
	);*/
	...
	$('.slideOutTip').each(function(){
		...
		*/
		$(this).width(30+$(this).find('.tipTitle').width());
	});
	...
	$('.plugin_file a').on("click", function(event){
